    ...
    <!-- Page level plugins -->
    <script src="<?= STATIC_DIR ?>/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?= STATIC_DIR ?>/js/demo/chart-area-demo.js"></script>
    <script src="<?= STATIC_DIR ?>/js/demo/chart-pie-demo.js"></script>
